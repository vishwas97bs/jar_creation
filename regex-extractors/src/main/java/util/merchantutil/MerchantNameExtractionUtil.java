...
public class MerchantNameExtractionUtil {
    ...
    private static final DBCollection STOPWORDS_COLLECTION;
    private static final Set<String> STOPWORDS;
    public static final boolean ENABLE_SEQUENTIAL_LOOKUP = true;

    static {
        STOPWORDS_COLLECTION = MongoConnector.getDB( PropertyFileHandler.getProperty( "gimlet-core", Constants.MONGO_DB_NAME ) )
    ...
    public static boolean isStopword( String word )
    {
        for ( String stopword : STOPWORDS ) {
            if ( stopword.length() <= UtilConditions.MIN_LENGTH_LEVENSHTEIN && stopword.equals( word ) ) {
                return true;
            } else if ( stopword.length() > UtilConditions.MIN_LENGTH_LEVENSHTEIN && ( StringUtils
     ...
     */
    public static boolean isPossibleWebsite( String name )
    {
    ...
    public static List<String> clean( List<String> originalList )
    {
    ...
    public static List<String> lightClean( List<String> originalList )
    {
        List<String> finalList = new ArrayList<>();
        for ( String str : originalList ) {
    ...
    public static String lightCleanUp( String str )
    {
        String regex = "[^\\w.\\-'՟&!@()]+";
        if ( RegexUtils.checkIfStringContainsRegexPattern( str, "\\p{InCyrillic}" ) ) {
    ...
    public static List<String> reorder( List<String> originalList )
    {
        List<String> finalList = new ArrayList<>();
    ...
    public static List<String> nGrammify( String str, String separator, int length )
    {
     ...
     * @return n-gram List
     */
    public static List<NGram> getNGrams( List<String[]> lines, int maxLength, int minLength )
    {
     ...
     */
    public static String mkString( String[] strParts, String separator, int startIndex, int stopIndex )
    {
        StringBuilder sb = new StringBuilder();
     ...
     */
    public static String extractPotentialName( String line )
    {
     ...
     */
    public static List<String[]> tokenizeText( List<String> lines )
    {
