...
import common.helpers.LineParser;
...
public class MongoConnector
{
    ...
    private static final String MONGO_DEFAULT = Utils.getOrDefault( System.getenv( "MONGO_CONNECTION" ),
        PropertyFileHandler.getProperty( "gimlet-core", "mongoServer" ) );
